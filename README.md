...
- 📫 How to reach me: **sameerhussainmughal3@gmail.com**
- 😄 Pronouns: **He/Him**
...
- **Data Engineering Tools:** Snowflake, Apache Airflow, Apache Kafka  
- **Programming & Scripting Languages:** Python, SQL  
- **Frontend Development:** HTML, CSS, JavaScript, TypeScript, React.js, Next.js  
- **Data Analysis & Optimization:** NumPy, Pandas, Matplotlib, BeautifulSoup, Selenium  
- **Frontend Frameworks & Libraries:** Tailwind CSS, Framer Motion, Shadcn UI  

---

## 📘 Currently Learning
- Building **ETL pipelines** using **Python (Pandas, Airflow)**  
- Working on **Data Warehousing** using **PostgreSQL & Snowflake**  
- Learning **AWS Cloud Services** (S3, EC2, Lambda, Glue)  
- Practicing **Docker, Git & CI/CD pipelines**  
- Exploring **Machine Learning basics** for data integration  

> 🧠 *Actively improving my skills through hands-on projects, online labs, and continuous learning.*
